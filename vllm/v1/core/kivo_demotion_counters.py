...
class KivoDemotionCounters:
    ...
    sketch_span_old_blocks_considered: int = 0
    sketch_span_anchor_blocks_kept: int = 0
    sketch_span_neighbor_blocks_kept: int = 0
    sketch_span_missing_scores: int = 0
    ...
    last_sketch_span_anchor_ids_sample: tuple[int, ...] = ()
    last_sketch_span_keep_ids_sample: tuple[int, ...] = ()
    last_retention_ratio_numerator: int = 0
    last_retention_ratio_denominator: int = 0
    last_contiguous_span_count: int = 0
    last_max_gap_between_kept_blocks: int = 0
    ...
    last_row_block_count_before: int = 0
    last_row_block_count_after: int = 0
    last_visible_token_capacity_before: int = 0
    last_visible_token_capacity_after: int = 0
    last_kept_block_ids_contiguous: bool | None = None
    last_logical_positions_compacted: bool | None = None
    last_attention_num_tokens: int = 0
    last_attention_num_reqs: int = 0
    last_attention_max_seq_len_upper_bound: int = 0
    last_attention_query_start_loc_sample: tuple[int, ...] = ()
    last_attention_seq_lens_sample: tuple[int, ...] = ()
    last_attention_positions_sample: tuple[int, ...] = ()
    last_slot_mapping_length: int = 0
    last_slot_mapping_sample: tuple[int, ...] = ()
